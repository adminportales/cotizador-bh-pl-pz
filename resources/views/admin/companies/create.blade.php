    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Company</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="manager" type="text" class="form-control" id="manager" placeholder="Manager">@error('manager') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
