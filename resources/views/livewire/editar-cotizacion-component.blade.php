    ...
    <div class="card-body">
        <ul class="nav nav-tabs mb-2">
            <li class="nav-item" style="cursor: pointer">
                <a class="nav-link {{ $visibleTab == 'productos' ? 'active' : '' }}"
                    wire:click="mostrarTab('productos')">Productos Cotizados</a>
            </li>
            <li class="nav-item" style="cursor: pointer">
                <a class="nav-link {{ $visibleTab == 'presentacion' ? 'active' : '' }}"
                    wire:click="mostrarTab('presentacion')">Crea tu presentacion</a>
            </li>
        </ul>
        @if ($visibleTab == 'productos')
            <div class="p-3">
                                    ...
                                    @if ($puedeEditar)
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center">
                                                <div>
                                                    <button class="btn btn-light shadow-none text-center"
                                                        data-toggle="modal" data-target="#modalCotizador">
                                                        <div class="d-flex justify-content-center w-100">
                                                            <div style="width: 1rem;">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-6 w-6 w-100" fill="none"
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($quote->company_id == auth()->user()->company_session)
                                    <div class="text-success" style="width: 25px; cursor: pointer;"
                                        data-toggle="modal" data-target="#discountModalEdit" data-toggle="tooltip"
